...
function Submit(){
  ...
  <body>
  	<div>
  		<h3>添加账户</h3>
  		<s:form id="fuseradd" action="admin_add.action?m=add">
  		<table class="list-layout wd-600">
  			...
  			<tr>
  				<th>登录名</th>
  				<td><s:textfield name="admin.uid" size="30" maxlength="50" /></td>
  			</tr>
  			<tr>
  				<th>密码</th>
  				<td><s:password id="pwd" name="pwd" size="30" maxlength="50" /></td>
  			</tr>
  			<tr>
  				<th>确认密码</th>
  				<td><s:password id="pwd1" name="pwd1" size="30" maxlength="50" /></td>
  			</tr>
  			<tr>
  				<th>用户组</th>
  				<td>
